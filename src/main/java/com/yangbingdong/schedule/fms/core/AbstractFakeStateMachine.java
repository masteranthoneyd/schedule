package com.yangbingdong.schedule.fms.core;
...
public abstract class AbstractFakeStateMachine<S extends Enum<S>, E extends Enum<E>, SOURCE extends StateSource<S>> implements InitializingBean {
	...
	public void fire(SOURCE s, E e) throws Exception{
	...
	public void afterPropertiesSet() {
		Class<?> temp = findAbstractFakeMachineClass();
		Type actualTypeArgument = ((ParameterizedType) Objects.requireNonNull(temp).getGenericSuperclass()).getActualTypeArguments()[0];
